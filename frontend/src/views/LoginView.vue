      ...
      <div class="px-6 py-5">
        ...
        <div class="flex justify-center mb-4">
          <button
            ...
            class="w-10 h-10 rounded-xl border border-gray-300 bg-white shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 flex items-center justify-center"
